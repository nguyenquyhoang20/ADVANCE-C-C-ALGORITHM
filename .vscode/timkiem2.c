...
#include <stdlib.h>
#include <string.h>
#include <locale.h>  // Thư viện hỗ trợ setlocale và LC_ALL
    ...
    do {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                char phone[20];  // Khai báo biến phone
                fgets(phone, sizeof(phone), stdin);
            
                phone[strcspn(phone, "\n")] = 0; // Xóa ký tự newline
                // Sắp xếp mảng theo số điện thoại
...
int main() {
    ...
    // Thiết lập locale, "vi_VN.UTF-8" là thiết lập cho tiếng Việt với UTF-8
